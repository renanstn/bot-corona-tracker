...
class Bot:
    ...
    def send_report(self, global_report, local_report):
        report = (
            ...
            f"- Casos só hoje: {global_report['total_new_cases_today']}\n"
            f"- Mortes só hoje: {global_report['total_new_deaths_today']}\n"
            "\n"
            "======== Situação no Brasil ========\n"
            f"- Total de casos: {local_report['total_cases']}\n"
            f"- Total de mortes: {local_report['total_deaths']}\n"
            f"- Casos só hoje: {local_report['total_new_cases_today']}\n"
            f"- Mortes só hoje: {local_report['total_new_deaths_today']}\n"
            "\n\n"
